        ...
        <el-row style="margin-top: 20px;">
  			<el-col :span="12" :offset="4">
		        <el-form :model="formData" :rules="rules" ref="formData" label-width="110px" class="demo-formData">
					<el-form-item label="材料商名称" prop="name">
					...
					<el-form-item label="材料商简介" prop="description">
						<el-input v-model="formData.description"></el-input>
					</el-form-item>
					<el-form-item label="材料商标语" prop="promotion_info">
						<el-input v-model="formData.promotion_info"></el-input>
					</el-form-item>
					<el-form-item label="材料商分类">
						<el-cascader
					...
					<el-form-item label="材料商特点" style="white-space: nowrap;">
						<span>品牌保证</span>
    ...
    export default {
    	data(){
    		return {
		        ...
		        rules: {
					name: [
						{ required: true, message: '请输入材料商名称', trigger: 'blur' },
					],
					address: [
